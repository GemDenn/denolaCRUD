<?php $index = 1; foreach($search_result as $search_results) { ?>
    <tr>
        ...
        <td class="text-center align-middle">
            <!-- <button onclick="update_item('<? /*=  $search_results['id'] */?>')" class="btn btn-primary btn-size-w btn-size-h align-middle">EDIT</button> -->
            ...
            <!-- <button onclick="delete_item('<? /*=  $search_results['id']*/ ?>')" class="btn btn-danger btn-size-w btn-size-h align-middle">DELETE</button> -->
        </td>
    </tr>
<?php $index++; } ?>